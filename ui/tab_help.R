fluidPage(
  ...
  fluidRow(
    ...
    column(width = 4, offset = 0,
      ...
      htmltools::hr(),      
      htmltools::div(
        htmltools::h5("App creacted by Roc and Noemi with love for Kume, Marc C., Marc A., Marius."),
        htmltools::h4("Happy 40's!!"),
        htmltools::h5("Thanks to Tyler Rinker which posted in his blog 'TRinker's R Blog' about the puzzle, and shared the layers structure. Take a look to his blog and the his post about how to find the solution of this puzzle in R here :"),
